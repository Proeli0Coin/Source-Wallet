...
In order to support loading of multiple wallets in proelio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is proelio.cpp.
...
Changes to proelio.cpp
----------------------
proelio.cpp is the entry point into proelio-qt, and as such, will require some minor modifications to provide hooks for
