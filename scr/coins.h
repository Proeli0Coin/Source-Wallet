...
// Copyright (c) 2016-2017 The Proelio developers
...
/** 
    ...
    ****Note - for Proelio we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of proelio coming in to a transaction
