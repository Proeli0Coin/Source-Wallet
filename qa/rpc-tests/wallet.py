...
#   c) node1 mines 32 blocks, so now node 0 has 60001tup, node 1 has 4250tup, node2 has none.
#   d) node0 sends 601 PEO to node2, in two transactions (301 PEO, then 300 PEO).
