...
RESOURCES += src/qt/proelio.qrc src/qt/proelio_locale.qrc

TRANSLATIONS += src/qt/locale/proelio_bg.ts \
                src/qt/locale/proelio_de.ts \
                src/qt/locale/proelio_en.ts \
                src/qt/locale/proelio_es.ts \
                src/qt/locale/proelio_fi.ts \
                src/qt/locale/proelio_fr.ts \
                src/qt/locale/proelio_it.ts \
                src/qt/locale/proelio_ja.ts \
                src/qt/locale/proelio_pl.ts \
                src/qt/locale/proelio_pt.ts \
                src/qt/locale/proelio_ru.ts \
                src/qt/locale/proelio_sk.ts \
                src/qt/locale/proelio_sv.ts \
                src/qt/locale/proelio_vi.ts \
                src/qt/locale/proelio_zh_CN.ts \
                src/qt/locale/proelio_zh_TW.ts
