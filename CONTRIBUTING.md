Contributing to Proelio Core
============================

The Proelio Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Proelio Core project, and is not to be
confused with overall Proelio Network Protocol consensus changes.

Whether a pull request is merged into Proelio Core rests with the project merge
...
Patches that change Proelio consensus rules are considerably more involved than
...
Where a patch set proposes to change the Proelio consensus, it must have been
...
The project leader is the release manager for each Proelio Core release.
